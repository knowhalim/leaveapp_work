...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <div style="background-color: #f9fafb; padding: 20px; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 8px 8px;">
        ...
        <p>We regret to inform you that your leave request has been <strong style="color: #DC2626;">rejected</strong>.</p>
        ...
        <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
            ...
            <tr>
                <td style="padding: 10px; border-bottom: 1px solid #e5e7eb; font-weight: bold;">Rejected By:</td>
                <td style="padding: 10px; border-bottom: 1px solid #e5e7eb;">{{ $leaveRequest->approver->name ?? 'System' }}</td>
            </tr>
            <tr>
                <td style="padding: 10px; border-bottom: 1px solid #e5e7eb; font-weight: bold;">Rejected On:</td>
        ...
        <div style="text-align: center; margin: 30px 0;">
            <a href="{{ url('/leaves/' . $leaveRequest->id) }}" style="background-color: #6b7280; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; display: inline-block;">View Details</a>
        </div>

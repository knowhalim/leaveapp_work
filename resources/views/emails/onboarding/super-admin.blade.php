<p style="margin: 0 0 15px 0;">As {{ preg_match('/^[aeiouAEIOU]/', $roleLabel ?? 'Super Administrator') ? 'an' : 'a' }} <strong>{{ $roleLabel ?? 'Super Administrator' }}</strong>, you have full system control:</p>
...
<div style="background-color: #fee2e2; border-radius: 6px; padding: 15px; margin-top: 15px;">
    <p style="margin: 0; font-weight: bold; color: #991b1b;">Super Admin Security Notice</p>
    <ul style="margin: 10px 0 0 0; padding-left: 20px; color: #991b1b;">
        ...
        <li>Limit the number of super admin accounts to maintain security.</li>
    </ul>
</div>

<div style="background-color: #eff6ff; border-radius: 6px; padding: 15px; margin-top: 15px;">
    <p style="margin: 0; font-weight: bold; color: #1d4ed8;">Quick Access Links</p>
    <ul style="margin: 10px 0 0 0; padding-left: 20px;">
        <li><a href="{{ url('/settings') }}" style="color: #2563eb;">System Settings</a></li>
        <li><a href="{{ url('/users') }}" style="color: #2563eb;">User Management</a></li>
        <li><a href="{{ url('/activity-logs') }}" style="color: #2563eb;">Activity Logs</a></li>
    </ul>
</div>

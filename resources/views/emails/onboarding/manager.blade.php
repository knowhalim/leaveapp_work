<p style="margin: 0 0 15px 0;">As {{ preg_match('/^[aeiouAEIOU]/', $roleLabel ?? 'Manager') ? 'an' : 'a' }} <strong>{{ $roleLabel ?? 'Manager' }}</strong>, you have additional responsibilities in {{ \App\Models\SystemSetting::getCompanyName() }}:</p>
...
<ol style="margin: 0; padding-left: 20px;">
    ...
    <li style="margin-bottom: 10px;">
        ...
        <span style="color: #6b7280;">As a manager, your leave requests will be routed to administrators for approval.</span>
    </li>
    <li style="margin-bottom: 10px;">
...
<div style="background-color: #eff6ff; border-radius: 6px; padding: 15px; margin-top: 15px;">
    <p style="margin: 0; font-weight: bold; color: #1d4ed8;">Manager Tips</p>

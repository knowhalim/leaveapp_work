...
import { Settings, Calendar, Building2, Mail, MailOpen, Plus, Edit, Trash2, X, Users, Clock, Plug} from 'lucide-react';
    ...
    return (
        <AuthenticatedLayout title="Employee Types">
            ...
            {employeeTypes.last_page > 1 && (
                <div className="mt-6 bg-white px-4 py-3 rounded-lg shadow flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3">
                    <div className="text-sm text-gray-700">
                        Showing {employeeTypes.from} to {employeeTypes.to} of {employeeTypes.total} results
                    </div>
                    <div className="flex flex-wrap gap-1">
                        {employeeTypes.links.map((link, i) => (
                            <Link
                                key={i}
                                href={link.url || '#'}
                                preserveScroll

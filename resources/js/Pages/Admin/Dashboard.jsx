...
import { Users, Building2, Clock, CheckCircle, Calendar, Plus } from 'lucide-react';
import { formatDate } from '@/lib/utils';

export default function AdminDashboard({ stats, pendingRequests, departments, financialYear }) {
    const statCards = [
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="bg-white shadow rounded-lg">
                    <div className="px-4 py-5 sm:px-6 border-b border-gray-200 flex justify-between items-center">
                        ...
                        <Link href="/departments" className="text-sm text-indigo-600 hover:text-indigo-500">
                            Manage
                        </Link>
                    </div>
                    <ul className="divide-y divide-gray-200">
                        {departments.length === 0 ? (
                            <li className="px-4 py-4 text-sm text-gray-500">No departments</li>
                        ) : (
                            departments.map((department) => (
                                <li key={department.id} className="px-4 py-4">
                                    <div className="flex items-center justify-between">
                                        <div>
